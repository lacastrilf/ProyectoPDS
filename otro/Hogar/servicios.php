...
$sql = "SELECT servicios FROM presupuestos WHERE id_usuario='$idUsuario'";
$resultado = $conexion->query($sql);
$dato = $resultado->fetch_assoc();

if ($dato) {
    $_SESSION['presupuesto'] = $dato['servicios'];
    $presupuesto = $dato['servicios'];
} else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["presupuesto"])) {
    ...
    if ($resultado->num_rows > 0) {
        $sqlUpdate = "UPDATE presupuestos SET servicios=$nuevoPresupuesto WHERE id_usuario='$idUsuario'";
        $conexion->query($sqlUpdate);
    } else {
        $sqlInsert = "INSERT INTO presupuestos (id_usuario, servicios) VALUES ('$idUsuario', $nuevoPresupuesto)";
...
$sql = "SELECT SUM(gasto) AS total_gastos FROM gastosI WHERE id_usuario='$idUsuario' AND tipo='Servivios'";
$resultado = $conexion->query($sql);
$totalGastos = 0;
if ($resultado->num_rows > 0) {
    $dato = $resultado->fetch_assoc();
...
$sqlUpdate="UPDATE diagramagastoshogar SET servicios='$totalGastos' WHERE idUsuario='$idUsuario'";
...
if(isset($_POST['agregarEvento'])){
  ...
  $sqlInsertEvento = "INSERT INTO servicios VALUES ('null','$idUsuario','$nombreEvento','$presupuestoEvento','$fecha')";
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Servicios<span>/Semanales</span></h5>
                  ...
                  <table class="table table-borderless">
                    ...
                    <?php
                    $conexion = new mysqli("localhost", "root", "", "base_proyecto");
                    $sqlGetEventos = "SELECT * FROM servicios WHERE idUsuario='$idUsuario'";
                    $resultado=mysqli_query($conexion, $sqlGetEventos);
                    if($resultado){
                      while($row = $resultado->fetch_array()){
                        $nombreEvento=$row['nombreServicios'];
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div style="height: 390px;">
                        <?php
                        $sqlGetEventos = "SELECT * FROM gastosi WHERE id_usuario='$idUsuario' AND tipo='Servicios'";
                        $resultado=mysqli_query($conexion, $sqlGetEventos);
                        if($resultado){
                            while($row = $resultado->fetch_array()){

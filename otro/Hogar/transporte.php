...
$sqlUpdate="UPDATE diagramagastoshogar SET transporte='$totalGastos' WHERE idUsuario='$idUsuario'";
                ...
                <div class="card-body">
                    ...
                    <div class="activity">
                      <div style="height: 450px;">
                        <?php
                        $sqlGetEventos = "SELECT * FROM gastosi WHERE id_usuario='$idUsuario' AND tipo='Transporte'";

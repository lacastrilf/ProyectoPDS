...
$sql = "SELECT presupuesto FROM vivienda WHERE id_usuario='$idUsuario'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["presupuesto"])) {
    ...
    $sql = "SELECT * FROM vivienda WHERE id_usuario='$idUsuario'";
    $resultado = $conexion->query($sql);

    if ($resultado->num_rows > 0) {
        $sqlUpdate = "UPDATE vivienda SET presupuesto=$nuevoPresupuesto WHERE id_usuario='$idUsuario'";
        $conexion->query($sqlUpdate);
    } else {
        $sqlInsert = "INSERT INTO vivienda (id_usuario, presupuesto) VALUES ('$idUsuario', $nuevoPresupuesto)";

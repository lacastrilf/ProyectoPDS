...
$sql = "SELECT presupuesto FROM ocio WHERE id_usuario='$idUsuario'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["presupuesto"])) {
    ...
    $sql = "SELECT * FROM ocio WHERE id_usuario='$idUsuario'";
    $resultado = $conexion->query($sql);

    if ($resultado->num_rows > 0) {
        $sqlUpdate = "UPDATE ocio SET presupuesto=$nuevoPresupuesto WHERE id_usuario='$idUsuario'";
        $conexion->query($sqlUpdate);
    } else {
        $sqlInsert = "INSERT INTO ocio (id_usuario, presupuesto) VALUES ('$idUsuario', $nuevoPresupuesto)";

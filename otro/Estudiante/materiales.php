                      ...
                      <div class="card-body">
                          ...
                          <div class="d-flex align-items-center">
                              ...
                              <div class="ps-3">
                                  ...
                                  $sql = "SELECT presupuesto FROM material WHERE id_usuario='$idUsuario'";
                                  ...
                                  if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["presupuesto"])) {
                                      ...
                                      $sql = "SELECT * FROM material WHERE id_usuario='$idUsuario'";
                                      $resultado = $conexion->query($sql);

                                      if ($resultado->num_rows > 0) {
                                          $sqlUpdate = "UPDATE material SET presupuesto=$nuevoPresupuesto WHERE id_usuario='$idUsuario'";
                                          $conexion->query($sqlUpdate);
                                      } else {
                                          $sqlInsert = "INSERT INTO material (id_usuario, presupuesto) VALUES ('$idUsuario', $nuevoPresupuesto)";
